...
fileinput = "Resources/paragraph_2.txt"
fileoutput = "Analysis/output.txt"

# String variable to hold the paragraph contents
paragraph = ""

# Read the text file
with open(fileinput) as txt_data:
...
# Split the original paragraph based on punctuation (. ? !)
...
with open(fileoutput, "a") as txt_file:
